...
import { updateSubCategory } from "../../redux/actions/KisanBazaar/category";
 ...
 */
const EditSubCategoryIcon = (props) => {
  ...
  const handleSubmit = async () => {
    if (typeof imageUrl === "object") {
      ...
      await dispatch(updateSubCategory(initialValue))
        .then(() => {
          handleModalClose();
    ...
    <div>
      ...
      >
        <Modal.Header closeButton>
          <div className="row">
            <div className="col-9">
              <Modal.Title className="mpdalTitle">Edit SubCategory</Modal.Title>
            </div>
          </div>
        </Modal.Header>
        <Modal.Body>
...
export default EditSubCategoryIcon;
